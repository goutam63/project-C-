<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="players.aspx.cs" Inherits="newBCCI.players" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="grdplayersList" runat="server" AutoGenerateColumns="False" DataKeyNames="PlayerID" DataSourceID="Sqldsplayers">
                <Columns>
